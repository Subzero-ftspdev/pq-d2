 ...
 */
    ...
    function got_ctcp($from,$to,$msg)
    {
        ...
        if(empty($ctcpreply))
        	sock_puts("NOTICE {$nick} :What kind of ctcp code was that? I don't understand");
        return $ctcpreply;
    }
